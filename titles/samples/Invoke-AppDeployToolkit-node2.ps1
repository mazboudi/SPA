...
$adtSession = @{
    ...
    AppScriptDate = '2026-04-02'
    AppScriptAuthor = 'Joe Cassera'
    RequireAdmin = $true

    # Install Titles (Only set here to override defaults set by the toolkit).
    InstallName = 'Node.js 25.8.2'
    InstallTitle = 'Node.js 25.8.2'
...
function Install-ADTDeployment
{
	...
	Start-ADTMsiProcess -Action 'Install' -FilePath 'node-v25.8.2-x64.msi' -ArgumentList '/QN REBOOT=ReallySuppress /norestart' -ErrorAction Stop
	...
	#Find App & Update Node.js Uninstall Key
