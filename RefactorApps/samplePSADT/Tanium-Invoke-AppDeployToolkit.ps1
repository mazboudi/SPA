...
function Install-ADTDeployment
{
    ...
    #Show-ADTInstallationWelcome -CloseProcesses '' -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt
    ...
    # Install vendor setup
     Start-ADTProcess -FilePath "$($adtSession.DirFiles)\SetupClient.exe" -ArgumentList '/S' -WindowStyle 'Hidden'
...
function Uninstall-ADTDeployment
{
 ...
 if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message "$($adtSession.InstallTitle) is uninstalled successfully on your machine." -ButtonRightText 'OK' -Icon Information -NoWait
    }
...
function Repair-ADTDeployment
{
    ...
    if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message "$($adtSession.InstallTitle) is installed successfully on your machine." -ButtonRightText 'OK' -Icon Information -NoWait
    }
