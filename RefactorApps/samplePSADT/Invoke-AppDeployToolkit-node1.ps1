...
function Install-ADTDeployment
{
	...
	Start-ADTMsiProcess -Action 'Install' -FilePath 'node-v25.8.1-x64.msi' -ArgumentList '/QN REBOOT=ReallySuppress /norestart' -ErrorAction Stop
