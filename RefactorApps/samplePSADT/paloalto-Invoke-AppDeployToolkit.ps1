...
function Install-ADTDeployment
{
	...
	Start-ADTMsiProcess -Action 'Install' -FilePath 'GlobalProtect64-6.2.8-c948.msi' -ArgumentList 'REBOOT=ReallySuppress MSIDISABLERMRESTART=Disable MSIRESTARTMANAGER=1 MSIRESTARTMANAGERCONTROL=Disable MSIRMSHUTDOWN=2 ALLUSERS=1 /norestart /qn' -ErrorAction Stop
	...
	#Find App & Update GlobalProtect Uninstall Key
	...
	$InstallLocation = "C:\Program Files\Palo Alto Networks\GlobalProtect"
...
function Uninstall-ADTDeployment
{
	...
	Uninstall-ADTApplication -Name 'GlobalProtect' -ApplicationType 'MSI'
